...
<html lang="zh">
    <head>
        ...
        @if($students->count()===1)
                <title>打印{{$students->first()->name}}的作业</title>  
        @endif
    ...
    <body>
        <div class="container-fluid">
           ...
           <img src="{{asset('/imgs/logo20.png')}}" height="50px" class="float-left"> <h2 class="text-center"> {{$student->name}}{{now()->format('Y-m-d')}}的分享</h2>
            <table class="table table-bordered d-print-table">
                <thead>
                    <tr>                
                        ...
                        <td class="align-middle text-center" width="33.3%">{{App\Model\Constant::find($student->constant_school_id)->label_name}}</td>
                ...
                <tbody>                    
                    <!--tr>                           
                        ...
                        @php 
//                    $notes_from_parent = collect($notes->where('student_id',$student->id)->all()); 
                      $note = '';
...
//                        }
            ...
            <table class="table table-bordered border-dark">  
                ...
                <tbody>
                    ...
                    ->where('constant_school_id',$student->constant_school_id)
