...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('新增支出') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('spend.store') }}">
                        ...
                        <div class="form-group row">
                            <label for="name" class="col-md-4 col-form-label text-md-right">{{ __('支出名称（必填）') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="amount" class="col-md-4 col-form-label text-md-right">{{ __('金额（必填）') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="which_day" class="col-md-4 col-form-label text-md-right">{{ __('发生日期(不填为今日)') }}</label>

                            <div class="col-md-6">
                                <input id="which_day" type="date" class="form-control" name="which_day">
                            </div>
                        </div>
                        <div class="form-group row">
