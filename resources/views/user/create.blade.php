...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('添加用户') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('user.store') }}">
                        ...
                        <div class="form-group row">
                            <label for="password" class="col-md-4 col-form-label text-md-right">{{ __('密码（最短8位）') }}</label>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-md-6">
                               ...
                               @foreach($roles as $role)
                                <option value="{{$role->id}}">{{$role->label_name}}</option>
                                @endforeach
                            </select>
                            </div>
                        </div>
